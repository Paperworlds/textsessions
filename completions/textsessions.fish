...
complete -c textsessions -f -n "__fish_use_subcommand" -a "pin"            -d "Pin a session (eligible for jump --lead)"
complete -c textsessions -f -n "__fish_use_subcommand" -a "unpin"          -d "Unpin a session"
complete -c textsessions -n "__fish_seen_subcommand_from pin"   -xa "(textsessions sessions --names-only --limit 200 2>/dev/null)"
complete -c textsessions -n "__fish_seen_subcommand_from unpin" -xa "(textsessions sessions --names-only --limit 200 2>/dev/null)"
